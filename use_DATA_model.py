...
from main_DATA import ShipSpeedPredictorModel  # Import the model class from your main script

if __name__ == "__main__":
    # Define file paths and parameters
    model_state_dict_path = 'saved_DATA/Adam_relu_Optimizer/final_model.pth'
    scaler_X_path = 'saved_DATA/Adam_relu_Optimizer/scaler_X.save'
    scaler_y_path = 'saved_DATA/Adam_relu_Optimizer/scaler_y.save'
    ...
    if result is not None:
        ...
        import json
        with open('saved_DATA/Adam_relu_Optimizer/best_hyperparameters.json', 'r') as f:
