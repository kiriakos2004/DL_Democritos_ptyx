...
if __name__ == "__main__":
    ...
    model_state_dict_path = 'saved_PINN/Hera_Adam_tanh_Optimizer/final_model.pth'
    scaler_X_path = 'saved_PINN/Hera_Adam_tanh_Optimizer/scaler_X.save'
    scaler_y_path = 'saved_PINN/Hera_Adam_tanh_Optimizer/scaler_y.save'
    ...
    if result is not None:
        ...
        import json
        with open('saved_PINN/Hera_Adam_tanh_Optimizer/best_hyperparameters.json', 'r') as f:
